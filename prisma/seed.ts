...
async function main() {
    ...
    const passwd = await bcrypt.hash("123456789",10);
    ...
    console.log(`Usuario creado: ${user.nombre} ${user.apellido}`);   //  imprimo un mensaje en la consola indicando que el usuario ha sido creado, mostrando su nombre y apellido.
